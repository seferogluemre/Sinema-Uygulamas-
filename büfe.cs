...
namespace Sinema_Uygulaması
{
    public partial class büfe : Form
    {
        ...
        private void textPİZZA_TextAlignChanged(object sender, EventArgs e)
        {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand komut = new SqlCommand("update müşteri2 set müşteriSEPET=@e1,müşteriÜCRET=@e2 ", bg.sqlbaglantı());
            komut.Parameters.AddWithValue("@e1", rchKasamalzeme.Text);
            komut.Parameters.AddWithValue("@e2", textBoxTOPLAMTUTAR.Text);
